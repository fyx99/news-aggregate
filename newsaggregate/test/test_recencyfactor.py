...
class TestRecencyFactor(CustomTestcase):
    ...
    def test_recency(self: unittest.TestCase):
        ...
        article_list = [
            ...
            Article(114, "https://outlet1.com/article2", "", "", "114", "Sum1", datetime.datetime(2020, 2, 1), "https://outlet1.com/feed", "asdasd", "ACTIVE", "Text1"),
            Article(115, "https://outlet2.com/article1", "", "", "115", "Sum1", datetime.datetime(2020, 3, 1), "https://outlet2.com/feed", "asdasd", "ACTIVE", "Text1"),
            Article(116, "https://outlet2.com/article2", "", "", "116", "Sum1", datetime.datetime(2020, 3, 3), "https://outlet2.com/feed", "asdasd", "ACTIVE", "Text1"),
            Article(116, "https://outlet2.com/article2", "", "", "116", "Sum1", datetime.datetime(2020, 3, 3), "https://outlet2.com/feed", "asdasd", "ACTIVE", "Text1"),
            Article(116, "https://outlet2.com/article2", "", "", "116", "Sum1", datetime.datetime(2020, 3, 4), "https://outlet2.com/feed", "asdasd", "ACTIVE", "Text1"),
            Article(116, "https://outlet2.com/article2", "", "", "116", "Sum1", datetime.datetime(2020, 3, 5), "https://outlet2.com/feed", "asdasd", "ACTIVE", "Text1"),
            Article(116, "https://outlet2.com/article2", "", "", "116", "Sum1", datetime.datetime(2020, 3, 6), "https://outlet2.com/feed", "asdasd", "ACTIVE", "Text1"),
        ]
